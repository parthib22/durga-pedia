...
const TopMap: React.FC<TopMapProps> = ({ name }) => {
  ...
  useEffect(() => {
    ...
    console.log(bCheck);
    if((bCheck!=null && bCheck.length > 0 &&  typeof bCheck[0].kar !== "undefined" && bCheck[0].kar!=null))
  {
    ...
    if((sCheck != null && sCheck.length > 0 && typeof sCheck[0].kar !== "undefined" && sCheck[0].kar != null)){
    ...
    const directionsRenderer = new google.maps.DirectionsRenderer({ map: map });
      ...
      Ststch(0);
          const coordinatePairs = sCheck[0].kar.substring(0, sCheck[0].kar.length-1).split('|');
